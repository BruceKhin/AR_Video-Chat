 ...
 */
public class OpenCV_RTCRemoteVideoView extends QBRTCSurfaceView {
    ...
    public static ArrayList<Rect> arrayTrackBox = new ArrayList<Rect>();
    ...
    public OpenCV_RTCRemoteVideoView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public OpenCV_RTCRemoteVideoView(Context context) {
        super(context);
    }
